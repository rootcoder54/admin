  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-start items-start gap-4 py-10 px-10">
        ...
        <div className="w-full max-w-3xl rounded-2xl shadow-md bg-zinc-100 dark:bg-zinc-800 p-6">
        ...
        <div className="mx-auto h-full w-full max-w-3xl rounded-xl bg-zinc-500" />
      </div>
    </>
  );
}
